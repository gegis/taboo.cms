...
module.exports = {
  ...
  appLibStyles: {
    ...
    watch: ['app/assets/styles/lib/**/*.scss', 'app/modules/templates/client/themesAssets/styles/vars.scss'],
    preProcessor: sass.bind(this, { javascriptEnabled: true }),
  },
  appStyles: {
    src: ['app/assets/styles/index.scss', 'app/modules/**/client/styles/index.scss'],
    dest: {
      file: 'app.css',
      path: 'public/css',
    },
    watch: [
      ...
      'app/modules/**/client/styles/**/*.scss',
      '!app/modules/**/client/styles/admin/**/*.scss',
    ],
    preProcessor: sass.bind(this, { javascriptEnabled: true }),
  },
  themeStyles: {
    src: ['app/modules/templates/client/themes/**/styles/index.scss'],
    dest: {
      file: null, // do not concat
      path: 'public/css',
    },
    watch: [
      'app/modules/templates/client/themes/**/styles/*.scss',
      'app/modules/templates/client/themesAssets/styles/**/*.scss',
      '!app/modules/templates/client/themesAssets/styles/lib/*.scss',
    ],
    preProcessor: sass.bind(this, { javascriptEnabled: true }),
  },
  copy: {
