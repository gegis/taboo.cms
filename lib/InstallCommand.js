...
class InstallCommand {
  ...
  async init(cmsType, adminEmail) {
    ...
    this.cliHelper.log('=================================================================================', 'info');
    this.cliHelper.log("Please run 'npm i' to make sure everything is installed.", 'info');
    this.cliHelper.log("Do not forget to copy './config/SAMPLE.local.js' and rename to './config/local.js'", 'info');
    this.cliHelper.log('Make sure you have MongoDB server installed and running.', 'info');
    this.cliHelper.log("To start the app - just run 'npm start'", 'info');
