...
class InstallCommand {
  ...
  async copyFoldersByCmsType(cmsType, cmsPackageDir, installDir) {
    ...
    if (cmsType === 'headless') {
      await this.cliHelper.copyFolder(
        path.resolve(cmsPackageDir, 'lib/tpl/headless/app'),
        path.resolve(installDir, 'app')
      );
      await this.cliHelper.copyFolder(
        path.resolve(cmsPackageDir, 'lib/tpl/headless/config'),
        path.resolve(installDir, 'config')
      );
    }
  }
  ...
  async deleteFilesByCmsType(cmsType, installDir) {
    if (cmsType === 'classic' || cmsType === 'headless') {
      ...
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/App.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/ButtonLink.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/Dashboard.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/Footer.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/Header.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/IndexPage.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/Layout.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/Modal.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/NavLink.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/NoAccess.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/NotFound.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/components/UserRoute.jsx'));
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/galleries/client/components/GalleryModal.jsx')
      );
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/navigation/client/stores/NavigationStore.js')
      );
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/galleries/client/styles/index.less'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/pages/client/components/Page.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/pages/client/stores/PagesStore.js'));
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/uploads/client/components/DocumentUpload.jsx')
      );
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/users/client/components/AccountVerification.jsx')
      );
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/users/client/components/ChangePassword.jsx')
      );
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/users/client/components/MyProfile.jsx'));
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/users/client/components/ProfilePicture.jsx')
      );
      await this.cliHelper.deleteFile(
        path.resolve(installDir, 'app/modules/users/client/components/ResetPassword.jsx')
      );
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/users/client/components/SignIn.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/users/client/components/SignUp.jsx'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/users/client/stores/UsersStore.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/users/client/styles/index.less'));
    }
    if (cmsType === 'headless') {
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/acl/client/app.config.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/core/client/app.config.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/countries/client/app.config.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/navigation/client/app.config.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/pages/client/app.config.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/uploads/client/app.config.js'));
      await this.cliHelper.deleteFile(path.resolve(installDir, 'app/modules/users/client/app.config.js'));
    }
  }
  ...
  getReplaceInFilesByCmsType(cmsType) {
    ...
    if (cmsType === 'headless') {
      replaceInFiles.push({
        files: path.resolve(installDir, 'webpack.config.js'),
        from: "app: './app/modules/core/client/index.jsx',",
        to: "app: './app/assets/scripts/index.js',",
      });
    }
